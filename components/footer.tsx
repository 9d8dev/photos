...
const footer = () => {
  return (
    <footer className="max-w-screen-md px-6 md:px-4 flex flex-col gap-4 lg:gap- lg:py-12 py-8">
      ...
      <p>Design and Code by <a href="https://bridger.to">Bridger</a> and <a href="https://cameronyoungblood.com">Cameron</a> at <a href="https://9d8.dev">9d8.dev</a> and <a href="https://alpinecodex.com">Alpine Codex</a>.</p>
    </footer>
  );
};
